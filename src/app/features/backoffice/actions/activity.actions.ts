...
// export const deleteActivities=createAction('[activities Component] Delete Activities', props<{activities:IActivity[]}>());
// export const deleteActivitiesSuccess=createAction('[activities Component] Delete Activities success', props<{activities:IActivity[]}>());
